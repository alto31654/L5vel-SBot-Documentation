...
\item
  ...
  Head M5x8mm Machine Screws}
\item
  12 M5x30mm Machine Screws
\item
  8 M5x35mm Socket head Machine Screws
\item
  8 M5 Washers
\item
  8 M5 Nuts
...
\item
  1
  \href{https://www.bestbuy.com/product/anker-solix-c1000x-gen2-portable-power-station-2000w-1024-wh-capacity-dark-gray/JJ858RLLVK}{Anker
  Solix C1000x Gen 2}
\item
  2
...
Cut the 800mm extrusions to 508mm. 500mm can also be used but will leave
gaps in each corner. Place 3 T-Nuts in one side of each extrusion. Add a
...
Vertically install 4 extrusions, one at each corner. Tighten the set
screws.
...
using a T-Nut and a M5x8mm button head screw on each end. Use the
...
Cut a piece of 3x1" linear rail to 5.25" and a piece of the 2x1"
channel to 4". Use two M5x16mm bolts, washers, and nuts to secure the
channel to top of the existing channel on one of the sides that the
bottom two 20x20mm extrusions are not mounted to. Drill a through hole
on each groove on one side of the 2x1" extrusion that will align with
the holes of the channel in the configuration shown below. Using a
M5x35mm bolt, nut, and washer mount two 2x1" extrusions side by side on
the 2x1x4" channel. Use 2 T-Nuts, 2 M5x8mm bolts, and 4 washers to
create a stop point on the opposite side on the extrusion of the
mounting points. One washer should be in the T-Slot and one above.
Repeat these steps on the opposite side of the base to create the other
control box mount.

\begin{figure}[H]
\centering
\includegraphics[width=0.31\textwidth]{media/image75.jpeg}
\hfill
\includegraphics[width=0.31\textwidth]{media/image76.jpeg}
\hfill
\includegraphics[width=0.31\textwidth]{media/image77.jpeg}
\caption{Building a control box mount from linear rail and 2x1 channel
with a stop point on the opposite side.}
\end{figure}
...
\assemblystep{Install the Control Boxes}
Place an A/C control box on each control box stand. Be sure that the
emergency stop is facing outwards and the power switch is facing the
side designated as the back. The handle may need to be removed from the
unit. Affix with a double-sided adhesive, such as Velcro. Adjust the
stop point bolts to be against the unit for additional support.

\begin{figure}[H]
\centering
\includegraphics[width=0.47\textwidth]{media/image87.jpeg}
\hfill
\includegraphics[width=0.47\textwidth]{media/image88.jpeg}
